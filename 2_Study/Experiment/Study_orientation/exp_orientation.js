...
var example_target = {
  ...
  'condition': function(){
    ...
    }else if(jsPsych.timelineVariable('cue') == dir+'orange.png'){
    ...
    }else if(jsPsych.timelineVariable('cue') == dir+'yellow.png'){
    ...
    }else if(jsPsych.timelineVariable('cue') == dir+'green.png'){
...
var extimeline_variables = [
  {cue:dir+'red.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),0,10)).slice(-3).toString()+'.png'},
  {cue:dir+'orange.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),60,10)).slice(-3).toString()+'.png'},
  {cue:dir+'yellow.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),120,10)).slice(-3).toString()+'.png'},
  {cue:dir+'green.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),180,10)).slice(-3).toString()+'.png'},
  {cue:dir+'blue.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),240,10)).slice(-3).toString()+'.png'},
  {cue:dir+'purple.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),300,10)).slice(-3).toString()+'.png'},
];
...
var prac_variables = [
  ...
  {cue:dir+'orange.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),0,10)).slice(-3).toString()+'.png'},
  {cue:dir+'yellow.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),0,10)).slice(-3).toString()+'.png'},
  {cue:dir+'green.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),0,10)).slice(-3).toString()+'.png'},
  {cue:dir+'blue.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),0,10)).slice(-3).toString()+'.png'},
  {cue:dir+'purple.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),0,10)).slice(-3).toString()+'.png'},

  {cue:dir+'yellow.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),60,10)).slice(-3).toString()+'.png'},
  {cue:dir+'green.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),60,10)).slice(-3).toString()+'.png'},
  {cue:dir+'blue.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),60,10)).slice(-3).toString()+'.png'},
  {cue:dir+'purple.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),60,10)).slice(-3).toString()+'.png'},


  {cue:dir+'green.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),120,10)).slice(-3).toString()+'.png'},
  {cue:dir+'blue.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),120,10)).slice(-3).toString()+'.png'},
  {cue:dir+'purple.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),120,10)).slice(-3).toString()+'.png'},
  
  {cue:dir+'blue.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),180,10)).slice(-3).toString()+'.png'},
  {cue:dir+'purple.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),180,10)).slice(-3).toString()+'.png'},

  {cue:dir+'purple.png',target: 'img/color/color_'+('00'+uniformwidth(Math.random(),240,10)).slice(-3).toString()+'.png'},
];
